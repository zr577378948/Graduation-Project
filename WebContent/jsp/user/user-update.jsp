...
<body>
	...
	<div>
		<form action="updateKeHu.handler" method="post">
			<table style="line-height: 40px;">
				<tr>
					<td align="right"><font>用户名:&nbsp;&nbsp;</font></td>
					<td><input type="hidden" name="kehu_id" value="${kehu.kehu_id }" readonly="readonly" >
					<input type="text" name="kehu_name" value="${kehu.kehu_name }" readonly="readonly" ></td>
				</tr>
				<tr>
					<td align="right"><font>性别:&nbsp;&nbsp;</font></td>
					<td><input type="text" name="kehu_sex" value="${kehu.kehu_sex }" readonly="readonly"></td>
				</tr>
				<tr>
					<td align="right"><font>身份证号:&nbsp;&nbsp;</font></td>
					<td><input type="text" name="kehu_number" value="${kehu.kehu_number }" readonly="readonly"></td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="kehu_native" value="${kehu.kehu_native }" readonly="readonly"></td>
				</tr>
				<tr>
					<td align="right"><font>手机号:&nbsp;&nbsp;</font></td>
					<td><input type="text" name="kehu_phone" value="${kehu.kehu_phone }"></td>
				</tr>

				<tr>
					<td align="right"><font>家庭住址:&nbsp;&nbsp;</font></td>
					<td><input type="text" name="kehu_family" value="${kehu.kehu_family }"></td>
				</tr>
				<tr>
